...
#define HANG_ADIDO 'G' //Defines a macro for the pnuematic hang mechanism's solenoid adi port and sets it to three wire port C
#define LIMIT_SWITCH 'B' //Defines a macro for the limit switch adi port and sets it to three wire port B
#define HANG_UP_ADIDO 'D' //Defines a macro for the pnuematic hang mechanism's up solenoid adi port and sets it to three wire port D
